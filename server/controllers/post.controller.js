...
const uploadPost = async (req, res) => {
  ...
  let { title, content, date, comment_ids, noice_ids, tags, img, link } = req.body;
  ...
  try {
    const post = await postRepository.savePost(user_id, title, content, date, comment_ids, noice_ids, tags, img, link);
...
module.exports = { getUserPosts, getPosts, getPostImage, uploadPost };
